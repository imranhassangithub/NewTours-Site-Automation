...
public class BookFlightTest {
	...
	public void checkBookFlight(List<BookFlight> bookFlights) throws InterruptedException {
		...
		for (BookFlight excelbookflight : bookFlights) {
			...
			driver.findElement(By.xpath(XpathUtils.BookFlight.Passenger1_Fname))
					.sendKeys(excelbookflight.getPassenger1Fname());
			driver.findElement(By.xpath(XpathUtils.BookFlight.Passenger1_Lname))
					.sendKeys(excelbookflight.getPassenger1Lname());
			driver.findElement(By.xpath(XpathUtils.BookFlight.Passenger2_Fname))
					.sendKeys(excelbookflight.getPassenger2Fname());
			driver.findElement(By.xpath(XpathUtils.BookFlight.Passenger2_Lname))
					.sendKeys(excelbookflight.getPassenger2Lname());
			...
			driver.findElement(By.xpath(XpathUtils.BookFlight.INPUT_CARD_FIRST_NAME))
					.sendKeys(excelbookflight.getCcFname());
			driver.findElement(By.xpath(XpathUtils.BookFlight.INPUT_CARD_MIDDLE_NAME))
					.sendKeys(excelbookflight.getCcMiddleName());
			driver.findElement(By.xpath(XpathUtils.BookFlight.INPUT_CARD_LAST_NAME))
					.sendKeys(excelbookflight.getCcLastName());
